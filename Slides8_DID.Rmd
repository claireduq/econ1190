...
regdidfe2<-felm(read4~post+treat+post*treat|class+year,scores)
...
stargazer(regnodid, regdid,regdidfe,regdidfe2, type="latex", header=FALSE, 
          add.lines = list(c("Class FE", "No", "No", "Yes", "Yes"),c("Year FE", "No", "No", "No", "Yes")), omit.stat = c("ser","rsq", "adj.rsq"))
```
...
regdidtwfe<-felm(read4~treat*year_1995+year_1996*treat+year_1997*treat+year_1998*treat
                 +year_1999*treat+year_2001*treat+year_2002*treat+year_2003*treat
                 +year_2004*treat+year_2005*treat
                 |year+class
                 |0
...
stargazer( regdidall2, regdidtwfe, type="latex",no.space=TRUE, header=FALSE, 
           single.row=TRUE, add.lines = list(c("Class and year FE", "No",  "Yes")), omit.stat = "all",  model.numbers          = FALSE)
