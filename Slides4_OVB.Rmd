...
Let $D_i$ be a binary treatment variable that could affect $Y_i$ which is the oucome $Y$ of observation $i$. Each unit faces two potential outcomes:
...
Suppose a constant treatment effect such that $\tau=Y_i(1)-Y_i(0)$: The treatment effect is the same for all observations. Then
